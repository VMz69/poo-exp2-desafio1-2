...
//        JLabel lblTitulo = new JLabel("CONSULTAR Y LISTAR LIBROS DE MEDIATECA", JLabel.CENTER);
//        panelNorth.add(lblTitulo, BorderLayout.NORTH);
    ...
    private void listarDisponibles() {
        JOptionPane.showMessageDialog(this, "Función: Mostrar/Listar solo libros disponibles");
        // aqui va la función para listar únicamente los libros disponibles (> 0)
    }
}
