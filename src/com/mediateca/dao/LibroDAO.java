...
public class LibroDAO {
    ...
    public void insertarLibro(Libro libro) throws SQLException {
        ...
        try{
            ...
            log.info("Iniciando insercion de com.mediateca.modelo.Libro con codigo: {}",  libro.getCodigo());
            ...
            stmt3.executeUpdate();
            conn.commit();
            log.info("Se ha insertado correctamente el com.mediateca.modelo.Libro con codigo: {}",  libro.getCodigo());
        } catch (SQLException e) {
            log.error("Error al insertar el com.mediateca.modelo.Libro con codigo: {} - {}", libro.getCodigo(), e.getMessage());
    ...
    public ArrayList<Libro> listarLibros() throws SQLException {
        ...
        try {
            ...
            log.info("Listando todos los registros de com.mediateca.modelo.Libro");
            while (rs.next()) {
            ...
            log.info("Listando {} registros de com.mediateca.modelo.Libro", lista.size());
        } catch (SQLException e){
    ...
    public void actualizarLibro(Libro libro) throws SQLException {
        ...
        try {
            ...
            log.info("Iniciando actualizacion de com.mediateca.modelo.Libro con codigo: {}", libro.getCodigo());
            stmt1 = conn.prepareStatement(sqlMaterial);
            stmt2 = conn.prepareStatement(sqlEscrito);
            stmt3 = conn.prepareStatement(sqlLibro);
            ...
            conn.commit();
            log.info("Actualizacion exitosa de  com.mediateca.modelo.Libro con codigo: {}", libro.getCodigo());
        } catch (SQLException e) {
            log.error("Error al actualizar com.mediateca.modelo.Libro con codigo : {} - {}", libro.getCodigo(), e.getMessage());
            if(conn != null) conn.rollback();
            throw e;
        } finally {
            ConexionBD.cerrar(stmt1);
    ...
    public void eliminarLibro(String codigo) throws SQLException {
        ...
        try {
            ...
            log.info("Iniciando eliminacion de com.mediateca.modelo.Libro con codigo: {}", codigo);
            stmt1 = conn.prepareStatement(sqlMaterial);
            stmt2 = conn.prepareStatement(sqlEscrito);
            stmt3 = conn.prepareStatement(sqlLibro);
            ...
            conn.commit();
            log.info("Eliminacion exitosa de com.mediateca.modelo.Libro con codigo: {}", codigo);
        } catch (SQLException e) {
            log.error("Error al eliminar el com.mediateca.modelo.Libro con codigo: {} - {}", codigo, e.getMessage());
            if(conn != null) conn.rollback();
            throw e;
        }
    }
