...
public class RevistaDAO {
    ...
    public void insertarRevista(Revista revista) throws SQLException {
        ...
        try {
            ...
            log.info("Iniciando insercion de com.mediateca.modelo.Revista con codigo: {}", revista.getCodigo());
            ...
            conn.commit();
            log.info("Se ha insertado correctamente la com.mediateca.modelo.Revista con codigo: {}", revista.getCodigo());
        } catch (SQLException e) {
            log.error("Error al insertar la com.mediateca.modelo.Revista con codigo: {} - {}", revista.getCodigo(), e.getMessage());
    ...
    public ArrayList<Revista> listarRevistas() throws SQLException {
        ...
        try {
            ...
            log.info("Listando todos los registros de com.mediateca.modelo.Revista");
            while (rs.next()) {
            ...
            log.info("Listado {} registros de com.mediateca.modelo.Revista", lista.size());
        } catch (SQLException e) {
            log.error("Error al listar los registros de com.mediateca.modelo.Revista: {}", e.getMessage());
            throw e;
        } finally {
    ...
    public void actualizarRevista(Revista revista) throws SQLException {
        ...
        try {
            ...
            log.info("Iniciando actualizacion de com.mediateca.modelo.Revista con codigo: {}", revista.getCodigo());
            stmt1 = conn.prepareStatement(sqlMaterial);
            stmt2 = conn.prepareStatement(sqlEscrito);
            stmt3 = conn.prepareStatement(sqlRevista);
            ...
            conn.commit();
            log.info("Actualizacion exitosa de com.mediateca.modelo.Revista con codigo: {}", revista.getCodigo());
        } catch (SQLException e) {
            log.error("Error al actualizar com.mediateca.modelo.Revista con codigo: {} - {}", revista.getCodigo(), e.getMessage());
            if (conn != null) conn.rollback();
            throw e;
        } finally {
            ConexionBD.cerrar(stmt1);
    ...
    public void eliminarRevista(String codigo) throws SQLException {
        ...
        try {
            ...
            log.info("Iniciando eliminacion de com.mediateca.modelo.Revista con codigo: {}", codigo);
            stmt3 = conn.prepareStatement(sqlRevista);
            stmt2 = conn.prepareStatement(sqlEscrito);
            stmt1 = conn.prepareStatement(sqlMaterial);
            ...
            conn.commit();
            log.info("Eliminacion exitosa de com.mediateca.modelo.Revista con codigo: {}", codigo);
        } catch (SQLException e) {
            log.error("Error al eliminar com.mediateca.modelo.Revista con codigo: {} - {}", codigo, e.getMessage());
            if (conn != null) conn.rollback();
            throw e;
        } finally {
            ConexionBD.cerrar(stmt1);
